...
public class BaseTest {
	...
	protected LandingPageGoogle navigateToGoogleLandingPage() {
		LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.HOME_PAGE_GOOGLE));
		driver.navigate().to(TestData.HOME_PAGE_GOOGLE);
		return PageFactory.create(LandingPageGoogle.class);
	}

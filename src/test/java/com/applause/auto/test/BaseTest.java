...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
    ...
    protected HomePage navigateToHomePage() {
        LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.AURORA_LANDING_PAGE_URL));
        driver.navigate().to(TestData.AURORA_LANDING_PAGE_URL);
        return PageFactory.create(HomePage.class);

             }


    protected RandomPage navigateToRandom() {
        LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.Skyscanner_LANDING_PAGE_URL));
        driver.navigate().to(TestData.Skyscanner_LANDING_PAGE_URL);
        return PageFactory.create(RandomPage.class);

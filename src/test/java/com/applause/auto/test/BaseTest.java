...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected LandingPageAndromeda navigateToLandingPageAndromeda() {
		LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.LANDING_PAGE_URL_ANDROMEDA));
		driver.navigate().to(TestData.LANDING_PAGE_URL_ANDROMEDA);
		return PageFactory.create(LandingPageAndromeda.class);
	}
}
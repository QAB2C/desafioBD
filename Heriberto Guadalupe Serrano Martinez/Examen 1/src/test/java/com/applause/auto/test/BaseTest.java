...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected GoogleSearchPage navigateGoogleSearchPage() {
		LOGGER.info(String.format("Navigating to the GoogleSearchPage page '%s'", TestData.GOOGLE_PAGE_URL));
		driver.navigate().to(TestData.GOOGLE_PAGE_URL);
		return PageFactory.create(GoogleSearchPage.class);
	}
}
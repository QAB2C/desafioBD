...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	 ...
	 */
	protected ActivityProductLoginChunck navigateToActivityProductLoginChunck() {
		LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.ACTIVITIES_PRODUCT_LOGIN_CHUNCK_URL));
		driver.navigate().to(TestData.ACTIVITIES_PRODUCT_LOGIN_CHUNCK_URL);

...
@WebDesktopImplementation(DesktopLandingPage2.class)
@WebTabletImplementation(TabletLandingPage2.class)
@WebPhoneImplementation(PhoneLandingPage2.class)
public abstract class AndromedaPage extends AbstractPage {
	...
	@WebElementLocator(webDesktop = "//input[@name='destination']")
 ...
 */
class DesktopLandingPage2 extends AndromedaPage {
 ...
 */
class TabletLandingPage2 extends AndromedaPage {
}

/**
 * Phone Implementation for LandingPage
 */
class PhoneLandingPage2 extends AndromedaPage {

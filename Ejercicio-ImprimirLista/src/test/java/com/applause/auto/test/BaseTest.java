...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected ValidacionesPage navigateToValidacionesPage() {
		LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.PAGE_URL));
		driver.navigate().to(TestData.PAGE_URL);
		return PageFactory.create(ValidacionesPage.class);
	}
}
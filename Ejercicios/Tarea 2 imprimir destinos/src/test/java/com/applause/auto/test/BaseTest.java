...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected AndromedaPage navigateToAndromedaPage() {
		LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.ANDROMEDA_PAGE_URL));
		driver.navigate().to(TestData.ANDROMEDA_PAGE_URL);
		return PageFactory.create(AndromedaPage.class);
	}

	protected ActivityProductLoginChunck navigateToActivityProductPage() {
		LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.ACTIVITIESPRODUCTLOGINCHUNCK_URL));
		driver.navigate().to(TestData.ACTIVITIESPRODUCTLOGINCHUNCK_URL);
		return PageFactory.create(ActivityProductLoginChunck.class);
	}
}
...
@WebDesktopImplementation(HotelListResultPage.class)
@WebTabletImplementation(HotelListResultPage.class)
@WebPhoneImplementation(HotelListResultPage.class)
public class HotelListResultPage extends AbstractPage {
	...
	@WebElementLocator(webDesktop = "#hotelList")

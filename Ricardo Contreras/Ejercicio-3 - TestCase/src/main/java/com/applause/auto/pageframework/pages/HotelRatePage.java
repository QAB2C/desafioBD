...
@WebDesktopImplementation(HotelRatePage.class)
@WebTabletImplementation(HotelRatePage.class)
@WebPhoneImplementation(HotelRatePage.class)
public class HotelRatePage extends AbstractPage {

...
import com.applause.auto.pageframework.helpers.KaleidoTestHelper;
...
public class BaseTest {
	...
	protected KaleidoTestHelper templateTestHelper;
	...
	public void beforeMethod(Method method) {
		...
		templateTestHelper = new KaleidoTestHelper();
	...
	/**
	 * Metodo para abrir la url con la clave del asociado que se dea usar para la prueba
	 * 
	 * @param Asociado
	 * @return Page
	 */
	protected HotelSearchPage navigateToLandingPage(String Asociado) {
		LOGGER.info(String.format("Navigating to the landing page '%s%s'", TestData.KALEIDO_PAGE_URL, Asociado));
		driver.navigate().to(String.format("%s%s", TestData.KALEIDO_PAGE_URL, Asociado));
		return PageFactory.create(HotelSearchPage.class);
	}
	 ...
	 * @return Page
	 */
	protected VideoChunk navigateToVideoPage() {
		LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.Video_PAGE_URL));
		driver.navigate().to(String.format("%s", TestData.Video_PAGE_URL));
		return PageFactory.create(VideoChunk.class);
	}

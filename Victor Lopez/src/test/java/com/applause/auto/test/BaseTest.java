...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected ExtranetAereosPage navigateToExtranetAereosPage() {
		LOGGER.info(String.format("Navigating to the Extranet Aereos '%s'", TestData.EXTRANETAEREOS_PAGE_URL));
		driver.navigate().to(TestData.EXTRANETAEREOS_PAGE_URL);
		return PageFactory.create(ExtranetAereosPage.class);
	}

	protected SiteFlightsPage navigateToSiteFlightsPage() {
		LOGGER.info(String.format("Navigating to the Flights '%s'", TestData.FLIGHTS_PAGE_URL));
		driver.navigate().to(TestData.FLIGHTS_PAGE_URL);
		return PageFactory.create(SiteFlightsPage.class);

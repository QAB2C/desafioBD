...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	public GooglePage navigateToGooglePage() {
		LOGGER.info(String.format("Navigating to the google page '%s'", TestData.LANDING_PAGE_GOOGLE_URL));
		driver.navigate().to(TestData.LANDING_PAGE_GOOGLE_URL);
		return PageFactory.create(GooglePage.class);
	}
}
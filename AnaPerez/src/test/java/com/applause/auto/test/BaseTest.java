...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected LandingPage navigateToAndromedaPage() {
		LOGGER.info(String.format("Navigate to the andromeda page '%s'", TestData.LANDING_PAGE_ANDROMEDA));
		driver.navigate().to(TestData.LANDING_PAGE_ANDROMEDA);
		return PageFactory.create(LandingPage.class);
	}
	
	protected LandingPage navigateToPaymentsFiltersPage() {

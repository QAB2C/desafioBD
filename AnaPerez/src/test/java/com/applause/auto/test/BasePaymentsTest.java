...
import com.applause.auto.pageframework.testdata.TestPageConstants.TestPaymentsData;

@Listeners(TestListener.class)
public class BasePaymentsTest {
	...
	protected LandingPaymentsPage navigateToPaymentsFiltersPage() {
		LOGGER.info(String.format("Navigate to the PaymentsFilters page '%s'", TestData.LANDING_PAGE_ANDROMEDA));
		driver.navigate().to(TestPaymentsData.PAGESFILTERS_PAGE_URL);
		return PageFactory.create(LandingPaymentsPage.class);
	}
}

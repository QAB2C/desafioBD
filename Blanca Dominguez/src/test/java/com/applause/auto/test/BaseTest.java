...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected GplanPage navigateToGplanPage() {
		LOGGER.info(String.format("Navigating to the Gplan page '%s'", TestData.GPLAN_PAGE_URL));
		driver.navigate().to(TestData.GPLAN_PAGE_URL);
		return PageFactory.create(GplanPage.class);
	}
}
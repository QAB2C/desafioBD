...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected LandingPage navigatePageReceptivo() {
		LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.LANDING_DMC));
		driver.navigate().to(TestData.LANDING_DMC);
		return PageFactory.create(LandingPage.class);
	}
}
...
public abstract class LandingPage extends AbstractPage {
	...
	public void clickServicesDmc() {
		LOGGER.info("Click sobre la sección de Servicios");
		getDestinationTextBox().click();
	...
	@WebElementLocator(webDesktop = "//a[@href='https://www.bestdaydmc.com/servicios/']")

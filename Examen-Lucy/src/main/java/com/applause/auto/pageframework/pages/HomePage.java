...
public abstract class HomePage extends AbstractPage {
	...
	public void enterBusqueda(String busquedaName) {
		LOGGER.info(String.format("Entering busqueda %s into search field", busquedaName));
		getBusquedaTextBox().setText(busquedaName);
		getBusquedaTextBox().click();

	}

	public ResultPage tapSearchButton() {
		getBusquedaTextBox().click();
		LOGGER.info("Tap on Search Button");
		return PageFactory.create(ResultPage.class);
	}
	/*
	 * public ResultPage enterBusqueda(String busquedaName) {
	 * LOGGER.info(String.format("Entering busqueda %s into search field", busquedaName));
	 * getBusquedaTextBox().setText(busquedaName); getBusquedaTextBox().click(); return
	 * PageFactory.create(ResultPage.class); }
	 * 

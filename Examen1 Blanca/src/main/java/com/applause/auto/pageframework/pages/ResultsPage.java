...
@WebDesktopImplementation(ResultsPage.class)
@WebTabletImplementation(ResultsPage.class)
@WebPhoneImplementation(ResultsPage.class)
public class ResultsPage extends AbstractPage {
	...
	@WebElementLocator(webDesktop = "div span")

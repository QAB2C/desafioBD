...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected HomeGooglePage navigateToGooglePage() {
		LOGGER.info(String.format("Navigating to the Google Home page '%s'", TestData.GOOGLEHOME_PAGE_URL));
		driver.navigate().to(TestData.GOOGLEHOME_PAGE_URL);
		return PageFactory.create(HomeGooglePage.class);
	}

...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected BusquedaGooglePage navigateToGooglePage() {
		LOGGER.info(String.format("Navigating into GOOGLE '%s'", TestData.HOME_PAGE));
		driver.navigate().to(TestData.HOME_PAGE);
		return PageFactory.create(BusquedaGooglePage.class);
	}
}
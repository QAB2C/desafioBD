...
public class BaseTest {
	...
	protected PagePrincipalGoogle LandingGoogle() {
		LOGGER.info(String.format("Navigating to the landing page '%s'", TestData.URL_Google));
		driver.navigate().to(TestData.URL_Google);
		return PageFactory.create(PagePrincipalGoogle.class);
	}
}
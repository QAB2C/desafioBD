...
//		System.setProperty("webdriver.chrome.driver", "src/main/resources/drivers/chromedriver");
	...
	protected HomePage navigateGoogleSearchPage() {
		LOGGER.info(String.format("Navigating to the GoogleSearchPage page '%s'", TestData.LANDING_PAGE_URL_GOOGLE));
		driver.navigate().to(TestData.LANDING_PAGE_URL_GOOGLE);
